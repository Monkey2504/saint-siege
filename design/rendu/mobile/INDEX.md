...
- `06-habemus-papam.png` — capturé, 87 Ko
- `07-edition-du-tour.png` — capturé, 71 Ko
- `08-ordres.png` — capturé, 50 Ko
- `09-registre.png` — capturé, 30 Ko
- `10-college.png` — capturé, 140 Ko
- `11-caisses.png` — capturé, 96 Ko
- `12-correspondance.png` — capturé, 70 Ko

Total du lot : 1714 Ko.
