...
Capturé le 2026-09-11 10:00 · commit b155c2d · source http://localhost:4173
...
- `04-bibliotheque-parties.png` — capturé, 92 Ko
- `05-bibliotheque-scenarios` — non atteint — locator.click: Timeout 20000ms exceeded.
- `06-habemus-papam` — non atteint — locator.click: Timeout 20000ms exceeded.
- `07-edition-du-tour.png` — capturé, 78 Ko
- `08-ordres.png` — capturé, 45 Ko
- `09-registre.png` — capturé, 25 Ko
- `10-college.png` — capturé, 141 Ko
- `11-caisses.png` — capturé, 51 Ko
- `12-correspondance.png` — capturé, 64 Ko

Total du lot : 1197 Ko.
