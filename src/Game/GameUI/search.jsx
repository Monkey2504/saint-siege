  ...
  return (
    <div
      style={{
        ...
        bottom: expanded && isMobile ? "7.6rem" : "3.6rem",
      ...
      >
        ...
        <input
          ...
          style={{
            ...
            border: "none",
            outline: "none",
            color: status === "error" ? "var(--oh-alert)" : "var(--oh-text-strong)",
        ...
        {expanded && (
          <button
            ...
            style={{
              ...
              padding: "0 0.6rem",
              height: "3rem",
              color: query.trim() ? "var(--oh-text)" : "var(--oh-text-dim)",
              display: "flex",
              alignItems: "center",
              flexShrink: 0,
              transition: "color 0.2s",
      ...
      {hasSuggestions && (
        <div
          style={{
            ...
            border: "1px solid var(--oh-line)",
            borderBottom: "none",
            boxShadow: "0 -6px 16px var(--oh-plate-2)",
            overflow: "hidden",
          }}
        >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: "0.55rem",
                  backgroundColor:
                    index === selectedIndex ? "var(--oh-plate-2)" : "transparent",
                  borderBottom:
