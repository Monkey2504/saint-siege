...
export const PROMPT_SECTION_DEFINITIONS = [
  ...
  {
    description: "Runs once per polity after its first jump: corrects the economic engine's era prior with the polity's actual history.",
    helpers: ["PLAYER_POLITY", "ORIGIN_ROUND_DATE", "WORLD_BEFORE_ROUND_ONE_TEXT", "HISTORICAL_PRESET_SIMULATION_RULES", "ALL_EVENTS_WITH_CONSOLIDATION"],
    key: "economySeed",
    label: "Economy Seed",
    type: "task",
  },
